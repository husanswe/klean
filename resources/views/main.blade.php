            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-5">
                    ...
                    <div class="d-flex mb-2">
                        <a class="text-secondary text-uppercase fw-medium" href="">Admin</a>
                        <span class="text-primary px-2">|</span>
                        <a class="text-secondary text-uppercase fw-medium" href="">Cleaning</a>
                    </div>
                    <h5 class="fw-medium mb-2">Rebum lorem eos ipsum diam</h5>
